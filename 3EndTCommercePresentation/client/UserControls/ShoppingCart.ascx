...
<div style="width: 98%; border-bottom: 1.5px solid #DDDDDD; margin-top: 5px" class="pull-left">
    ...
    <asp:LoginStatus ID="MainLoginStatus" LogoutAction="Redirect" LogoutPageUrl="/Default.aspx" runat="server" LoginText="Login" LogoutText="Logout" OnLoggedOut="MainLoginStatus_LoggedOut" />
