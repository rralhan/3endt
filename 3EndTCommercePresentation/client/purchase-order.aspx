                                                    ...
                                                    <div>
                                                        <div class="product-details-xsm">
                                                            ...
                                                            <div class="product-name">
                                                                <asp:Label ID="lblProductTitle" runat="server" Text='<%#Eval("ProductName")%>' />
                                                            </div>
                                                            <div class="itemselection">
                                                            ...
                                                            <div class="price">
                                                                <asp:Label ID="lblTotalPrice" data-name="price" runat="server" Text='<%#string.Format("$ {0:#,###0.00}", Eval("TotalPrice"))   %>' />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
